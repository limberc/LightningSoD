...
class DownsamplerBlockDepthwiseConv(nn.Module):
    def __init__(self, nIn, nOut):
        ...
        if self.nIn < self.nOut:
            ...
            self.conv1 = nn.Conv2d(nOut - nIn, nOut - nIn, 5, stride=2, padding=2, dilation=1, groups=nOut - nIn,
                                   bias=False)
...
class Backbone(nn.Module):
    def __init__(self, P1=1, P2=1, P3=3, P4=5, reduction=4, pretrained=None):
        ...
        self.level1 = nn.ModuleList([
            ConvBlock(16, 16) for _ in range(P1)
        ])
...
class HVPNet(nn.Module):
    '''
    This class defines the MiniNetV2 network
    '''

    def __init__(self, P1=1, P2=1, P3=3, P4=5, reduction=4, pretrained=None):
        super(HVPNet, self).__init__()
        ...
        self.classifier4 = nn.Sequential(nn.Dropout2d(0.1, False),
                                         nn.Conv2d(128, 1, 1, stride=1, padding=0, bias=False))
