...
class gycblock(nn.Module):
    def __init__(self, channels_in, channels_out):
        ...
        self.recp7 = nn.Sequential(
            BasicConv(channels_in * 1, channels_in, kernel_size=7, dilation=1, padding=3, groups=channels_in,
                      bias=False),
        ...
        self.recp5 = nn.Sequential(
            BasicConv(channels_in * 2, channels_in, kernel_size=5, dilation=1, padding=2, groups=channels_in,
                      bias=False),
            BasicConv(channels_in, channels_in, kernel_size=1, dilation=1, bias=False),
        ...
        self.recp3 = nn.Sequential(
            BasicConv(channels_in * 3, channels_in, kernel_size=3, dilation=1, padding=1, groups=channels_in,
                      bias=False),
            BasicConv(channels_in, channels_in, kernel_size=1, dilation=1, bias=False),
